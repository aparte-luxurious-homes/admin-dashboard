...
export function RateIcon({ className, color = "#191919", ...rest }: { className?: string, color?: string }) {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}
            className={`h-auto ${className}`}>
            <path d="M6.75 1.5H11.25C15 1.5 16.5 3 16.5 6.75V11.25C16.5 15 15 16.5 11.25 16.5H6.75C3 16.5 1.5 15 1.5 11.25V6.75C1.5 3 3 1.5 6.75 1.5Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.42773 11.4519L11.3327 6.54688" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M6.73501 7.77859C7.24449 7.77859 7.65749 7.36558 7.65749 6.8561C7.65749 6.34662 7.24449 5.93359 6.73501 5.93359C6.22553 5.93359 5.8125 6.34662 5.8125 6.8561C5.8125 7.36558 6.22553 7.77859 6.73501 7.77859Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M11.6403 12.0676C12.1497 12.0676 12.5628 11.6546 12.5628 11.1451C12.5628 10.6357 12.1497 10.2227 11.6403 10.2227C11.1308 10.2227 10.7178 10.6357 10.7178 11.1451C10.7178 11.6546 11.1308 12.0676 11.6403 12.0676Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};
...
export function CardsCycleIcon({ className, color = "#191919", ...rest }: { className?: string, color?: string }) {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}
            className={`h-auto ${className}`}>
            <path d="M9 4.17188H16.5" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M10.665 1.5H14.835C16.17 1.5 16.5 1.83 16.5 3.15V6.2325C16.5 7.5525 16.17 7.8825 14.835 7.8825H10.665C9.33 7.8825 9 7.5525 9 6.2325V3.15C9 1.83 9.33 1.5 10.665 1.5Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M1.5 12.7969H9" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3.165 10.125H7.335C8.67 10.125 9 10.455 9 11.775V14.8575C9 16.1775 8.67 16.5075 7.335 16.5075H3.165C1.83 16.5075 1.5 16.1775 1.5 14.8575V11.775C1.5 10.455 1.83 10.125 3.165 10.125Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M16.5 11.25C16.5 14.1525 14.1525 16.5 11.25 16.5L12.0375 15.1875" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M1.5 6.75C1.5 3.8475 3.8475 1.5 6.75 1.5L5.96251 2.8125" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
}
...
export function CardClockIcon({ className, color = "#191919", ...rest }: { className?: string, color?: string }) {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}
            className={`h-auto ${className}`}>
            <path d="M9 10.875C10.0355 10.875 10.875 10.0355 10.875 9C10.875 7.96447 10.0355 7.125 9 7.125C7.96447 7.125 7.125 7.96447 7.125 9C7.125 10.0355 7.96447 10.875 9 10.875Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M13.875 7.125V10.875" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3.75 16.5C5.40685 16.5 6.75 15.1569 6.75 13.5C6.75 11.8431 5.40685 10.5 3.75 10.5C2.09315 10.5 0.75 11.8431 0.75 13.5C0.75 15.1569 2.09315 16.5 3.75 16.5Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M3.9375 12.5625V13.26C3.9375 13.5225 3.80251 13.77 3.57001 13.905L3 14.25" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M1.5 11.4V6.75C1.5 4.125 3 3 5.25 3H12.75C15 3 16.5 4.125 16.5 6.75V11.25C16.5 13.875 15 15 12.75 15H6.375" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};
...
export function PriceTagIcon({ className, color = "#191919", ...rest }: { className?: string, color?: string }) {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}
            className={`h-auto ${className}`}>
            <path d="M3.30357 11.6448L6.70107 15.0423C8.09607 16.4373 10.3611 16.4373 11.7636 15.0423L15.0561 11.7498C16.4511 10.3548 16.4511 8.08977 15.0561 6.68727L11.6511 3.29728C10.9386 2.58478 9.95607 2.20228 8.95107 2.25478L5.20107 2.43478C3.70107 2.50228 2.50857 3.69478 2.43357 5.18728L2.25357 8.93727C2.20857 9.94977 2.59107 10.9323 3.30357 11.6448Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.30078 9.16797C8.33632 9.16797 9.17578 8.3285 9.17578 7.29297C9.17578 6.25743 8.33632 5.41797 7.30078 5.41797C6.26525 5.41797 5.42578 6.25743 5.42578 7.29297C5.42578 8.3285 6.26525 9.16797 7.30078 9.16797Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
            <path d="M9.92578 12.918L12.9258 9.91797" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
    );
};
...
export function UnitIcon({ className, color = "#191919", ...rest }: { className?: string, color?: string }) {
    return (
        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" >
            <path d="M1.5 16.5H16.5" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" {...rest}
                className={`h-auto ${className}`} />
            <path d="M2.21289 16.5009L2.25039 7.47841C2.25039 7.02091 2.46789 6.58595 2.82789 6.30095L8.07789 2.21344C8.61789 1.79344 9.3754 1.79344 9.9229 2.21344L15.1729 6.29344C15.5404 6.57844 15.7504 7.01341 15.7504 7.47841V16.5009" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round" />
            <path d="M11.625 8.25H6.375C5.7525 8.25 5.25 8.7525 5.25 9.375V16.5H12.75V9.375C12.75 8.7525 12.2475 8.25 11.625 8.25Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.5 12.1875V13.3125" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M7.875 5.625H10.125" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
