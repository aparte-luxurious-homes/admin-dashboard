...
export default function AllVerificationsTable() {
    ...
    const handleVerify = () => {
        ...
        const propertyId = selectedVerification?.propertyId ?? selectedVerification?.property_id ?? selectedVerification?.property?.id;
                                ...
                                <table className="w-full border-collapse">
                                    ...
                                    <tbody className="text-[11px] sm:text-xs md:text-sm">
                                        {verifications?.map((verification, index) => {
                                            const propertyId = verification?.propertyId ?? verification?.property_id ?? verification?.property?.id;
                                            const formattedId = propertyId ? `APRT25-${propertyId}` : '--/--';
                                            ...
                                            return (
                                                <tr
                                                    ...
                                                    onClick={() => {
                                                        router.push(PAGE_ROUTES.dashboard.propertyManagement.allProperties.verifications.details(propertyId, verification?.id));
                                                    }}
                                                >
                        ...
                        <>
                            <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-100">
                                ...
                                <p className="text-xs text-blue-600 mt-1">
                                    ID: APRT25-{selectedVerification?.propertyId ?? selectedVerification?.property_id ?? selectedVerification?.property?.id}
                                </p>
                            </div>
