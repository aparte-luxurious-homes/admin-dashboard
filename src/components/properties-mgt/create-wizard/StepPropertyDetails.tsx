...
function extractAddressComponents(components: AddressComponent[] = []) {
    ...
    for (const c of components) {
        ...
        else if (c.types.includes('route')) street_name = c.long_name;
    ...
    return { street_number, street_name, postal_code, city, state, country };
}
...
function applyGeocodeResultToForm(formik: any, result: any, description?: string) {
    ...
    if (parts.country) formik.setFieldValue('country', parts.country);
    ...
    return (
        <div className="relative group w-full">
            ...
            <input
                ...
                placeholder={!isLoaded ? 'Loading Map API...' : !ready ? 'Initializing...' : 'Search for an address...'}
                ...
                <div className="bg-white border border-zinc-200 rounded-2xl p-4 sm:p-6 space-y-5 shadow-sm">
                    ...
                    {!isNewOwner ? (
                            ...
                            {selectedOwner && (
                                <div className="mt-2 p-3 bg-primary/5 rounded-xl border border-primary/10 flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-zinc-500">{selectedOwner.email}</p>
                                    </div>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider ml-1">Owner Full Name</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-primary text-zinc-400">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider ml-1">Owner Email</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-primary text-zinc-400">
            ...
            <div className="bg-white border border-zinc-200 rounded-2xl p-4 sm:p-6 space-y-5 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider ml-1">Latitude</label>
                            <input
                                id="latitude"
                                type="number"
                                step="any"
                        ...
                        <div className="space-y-1.5">
                            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider ml-1">Longitude</label>
                            <input
                                id="longitude"
                                type="number"
                                step="any"
