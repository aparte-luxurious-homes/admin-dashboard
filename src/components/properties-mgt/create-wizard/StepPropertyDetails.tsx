...
function AddressAutocomplete({
  ...
  useEffect(() => {
    ...
    setAddressUage("This address cannot be used for another property");
      ...
      <div className="bg-white border border-zinc-200 rounded-2xl p-4 sm:p-6 space-y-5 shadow-sm">
        ...
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            {isLoaded ? (
              <AddressAutocomplete setAddress={setAddress} setAddressUage={setAddressUsage} formik={formik} isLoaded={isLoaded} />
            ) : (
              <div className="relative group w-full">
          ...
          {address !== "" && <p className="text-red-500 my-2">{addressUsage}</p>}
          {/* Long and Lat */}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              ...
              <CustomFilterDropdown
                ...
                selected={
                  ALL_COUNTRIES[formik.values.country] &&
                  Object.keys(ALL_COUNTRIES[formik.values.country])?.includes(
                    formik.values.state,
                  )
                    ? formik.values.state
                    : ""
