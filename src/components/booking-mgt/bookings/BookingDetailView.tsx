                  ...
                  <div className="flex gap-2 w-full sm:w-auto mt-2 md:mt-0">
                    ...
                    {isOwner && (
                      <button
                        ...
                        disabled={status !== BookingStatus.CHECKED_OUT}
                        ...
                        title={status !== BookingStatus.CHECKED_OUT ? "Disputes can only be raised after check-out" : ""}
                      >
                        <Icon 
                          icon="solar:danger-bold-duotone" 
                          className={`text-sm sm:text-base ${
                            status === BookingStatus.CHECKED_OUT ? "text-amber-600" : "text-zinc-400"
                          }`} 
                        />
