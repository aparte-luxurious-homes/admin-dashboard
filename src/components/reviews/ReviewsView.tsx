          ...
          <div className="flex justify-between items-center gap-4 flex-wrap mb-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                Monitor and moderate property reviews across the platform
              </p>
            </div>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 bg-white">
              ...
              <p className="text-sm text-gray-500">
                Wait for guests to start sharing their experiences
              </p>
            </div>
          )}
        </div>
                  ...
                  onClick={(e) => {
                    ...
                    dispatch(
                      showAlert({
                        title: "Flag Review",
                        description:
                          "Are you sure you want to flag this review? This will alert other users that it may contain inappropriate content.",
                        confirmText: "Flag",
                        cancelText: "Cancel",
                  ...
                  onClick={(e) => {
                    ...
                    dispatch(
                      showAlert({
                        title: "Unflag Review",
                        description:
                          "Are you sure you want to unflag this review?",
                        confirmText: "Unflag",
                        cancelText: "Cancel",
                  ...
                  onClick={(e) => {
                    ...
                    dispatch(
                      showAlert({
                        ...
                        description:
                          "Are you sure you want to restore this review? It will be visible on the platform again.",
                        confirmText: "Restore",
                        cancelText: "Cancel",
                  ...
                  onClick={(e) => {
                    ...
                    dispatch(
                      showAlert({
                        title: "Remove Review",
                        description:
                          "Are you sure you want to remove this review? This action is permanent and it will no longer be visible on the platform.",
                        confirmText: "Remove",
                        cancelText: "Cancel",
