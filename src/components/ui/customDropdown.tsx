  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <div
        ...
        className="relative w-full border border-zinc-400 rounded-lg p-5 h-14 mt-2 text-lg flex justify-start items-center cursor-pointer"
      >
        <span>{formatLabel ? formatLabel(selected) : selected}</span>
        <ArrowIcon
