    ...
    return (
        <div className="p-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-12 flex flex-col items-center justify-center text-center">
                ...
                <h1 className="text-2xl font-bold text-gray-900 mb-2">Dispute Case: {id}</h1>
                <p className="text-gray-500 max-w-md mb-8">
                    Detailed dispute resolution interface is coming soon. You'll be able to review evidence, communicate with parties, and issue final outcomes.
                </p>
                <div className="flex gap-4">
                    <button 
                         onClick={() => router.push(PAGE_ROUTES.dashboard.bookingManagement.bookingDisputes.base)}
