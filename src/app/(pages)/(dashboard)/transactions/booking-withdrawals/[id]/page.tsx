  ...
  return (
    <>
      <div className="p-[30px] mt-10 mb-100 border border-[#D9D9D9] rounded-[15px] bg-white shadow-md min-h-[calc(100vh-150px)]">
        <BreadCrumb
          description=""
          active="Booking Withdrawal Info"
          link_one="/transactions/booking-withdrawals"
          link_one_name="All Booking Withdrawals"
        />
        <div className="mt-0">
          <h3 className="mb-[50px] mt-[10px] font-semibold">Booking Withdrawals Info</h3>
...
export default BookingWithdrawalInfo;
