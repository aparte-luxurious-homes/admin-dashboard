export const API_ROUTES = {
  ...
  admin: {
    ...
    properties: {
      ...
      reassignOwner: (id: string | number) =>
        `/admin/properties/${id}/reassign-owner`,
      verificationStatus: (id: string | number) =>
    ...
    users: {
      ...
      uploadKycOnBehalf: (id: string | number) =>
    ...
    reviews: {
      ...
      unflag: (reviewId: string | number) =>
        `/admin/reviews/${reviewId}/unflag`,
      restore: (reviewId: string | number) =>
    ...
    disputes: {
      ...
      status: (disputeId: string | number) =>
        `/admin/disputes/${disputeId}/status`,
      requestEvidence: (disputeId: string | number) =>
        `/admin/disputes/${disputeId}/request-evidence`,
      resolve: (disputeId: string | number) =>
        `/admin/disputes/${disputeId}/resolve`,
      reopen: (disputeId: string | number) =>
        `/admin/disputes/${disputeId}/reopen`,
    },
    referrals: {
  ...
  propertyManagement: {
    properties: {
      ...
      amenities: (propertyId: string | number) =>
      ...
      verificationMedia: (id: string | number) =>
        `/properties/${id}/verifications/media`,
      units: {
        base: (propertyId: string | number) =>
          `/properties/${propertyId}/units`,
        details: (propertyId: string | number, unitId: string | number) =>
          `/properties/${propertyId}/units/${unitId}`,
        amenities: (propertyId: string | number, unitId: string | number) =>
          `/properties/${propertyId}/units/${unitId}/amenities`,
        media: (propertyId: string | number, unitId: string | number) =>
          `/properties/${propertyId}/units/${unitId}/media`,
        availability: (propertyId: string | number, unitId: string | number) =>
          `/properties/${propertyId}/units/${unitId}/availability`,
        deleteMedia: (
          propertyId: string | number,
          unitId: string | number,
          mediaId: string | number,
        ) => `/properties/${propertyId}/units/${unitId}/media/${mediaId}`,
      },
      deleteMedia: (propertyId: string | number, mediaId: string | number) =>
        `/properties/${propertyId}/media/${mediaId}`,
      documents: (propertyId: string | number) =>
        `/properties/${propertyId}/documents`,
      verifyDocument: (
        propertyId: string | number,
        documentId: string | number,
      ) => `/properties/${propertyId}/documents/${documentId}`,
      bookingMode: (propertyId: string | number) =>
        `/properties/${propertyId}/booking-mode`,
    },
    amenities: {
      base: "/amenities",
    },
  ...
  verifications: {
    base: "/verifications",
    details: (verificationId: string | number) =>
  ...
  bookings: {
    ...
    reconcilePayment: (id: string | number) =>
      `/bookings/${id}/reconcile-payment`,
    extensions: {
      base: (bookingId: string | number) => `/bookings/${bookingId}/extensions`,
      listAll: "/bookings/extensions/all",
      details: (bookingId: string | number, id: string | number) =>
        `/bookings/${bookingId}/extensions/${id}`,
      approve: (bookingId: string | number, id: string | number) =>
        `/bookings/${bookingId}/extensions/${id}/approve`,
      reject: (bookingId: string | number, id: string | number) =>
        `/bookings/${bookingId}/extensions/${id}/reject`,
      cancel: (bookingId: string | number, id: string | number) =>
        `/bookings/${bookingId}/extensions/${id}/cancel`,
    },
  },
  wallet: {
    base: "/wallets",
    ...
    approveWithdrawal: (id: string | number) =>
      `/wallets/${id}/approve-withdrawal`,
    rejectWithdrawal: (id: string | number) =>
      `/wallets/${id}/reject-withdrawal`,
    reverseWithdrawal: (id: string | number) =>
      `/wallets/${id}/reverse-withdrawal`,
    authorizeDisbursement: (id: string | number) =>
      `/wallets/${id}/authorize-disbursement`,
    resendDisbursementOtp: (id: string | number) =>
      `/wallets/${id}/resend-disbursement-otp`,
    ...
    transactions: {
      ...
      validate: (walletId: string, transactionId: string) =>
        `/wallets/${walletId}/transactions/${transactionId}/validate`,
    },
    payoutAccounts: {
      base: (walletId: string) => `/wallets/${walletId}/payout-accounts`,
      details: (walletId: string, accountId: string) =>
        `/wallets/${walletId}/payout-accounts/${accountId}`,
      verify: (walletId: string, accountId: string) =>
        `/wallets/${walletId}/payout-accounts/${accountId}/verify`,
    },
  },
  payments: {
  ...
  transactions: {
    ...
    approveRefund: (transactionId: string) =>
      `/wallets/transactions/${transactionId}/approve-refund`,
  },
  permissions: {
    base: "/permissions",
    ...
    assignToRole: (role: string, permissionId: string) =>
      `/permissions/roles/${role}/assign/${permissionId}`,
    removeFromRole: (role: string, permissionId: string) =>
      `/permissions/roles/${role}/remove/${permissionId}`,
    seed: "/permissions/seed",
  },
  reviews: {
    base: "/reviews",
    propertyReviews: (propertyId: string | number) =>
      `/properties/${propertyId}/reviews`,
    propertySummary: (propertyId: string | number) =>
  ...
  disputes: {
    ...
    deleteEvidence: (disputeId: string | number, evidenceId: string | number) =>
  ...
  reports: {
    statements: {
      ...
      download: (
        ...
        year: string | number,
        month: string | number,
      ) => `/reports/owners/${ownerId}/statements/${year}/${month}/download`,
      details: (
        ownerId: string,
        year: string | number,
        month: string | number,
      ) => `/reports/owners/${ownerId}/statements/${year}/${month}`,
    },
    bookings: {
  ...
  agents: {
    statements: {
      ...
      download: (
        ...
        year: string | number,
        month: string | number,
      ) => `/reports/agents/${agentId}/statements/${year}/${month}/download`,
    },
    bookings: {
  ...
  ical: {
    units: {
      ...
      outboundRotate: (unitId: string | number) =>
        `/ical/units/${unitId}/outbound/rotate`,
      feeds: (unitId: string | number) => `/ical/units/${unitId}/feeds`,
      feedAction: (unitId: string | number, feedId: string | number) =>
        `/ical/units/${unitId}/feeds/${feedId}`,
      syncFeed: (unitId: string | number, feedId: string | number) =>
        `/ical/units/${unitId}/feeds/${feedId}/sync`,
      externalBookings: (unitId: string | number) =>
        `/ical/units/${unitId}/external-bookings`,
    },
    admin: {
      feeds: "/ical/admin/feeds",
      forcePoll: (feedId: string | number) =>
        `/ical/admin/feeds/${feedId}/force-poll`,
      disable: (feedId: string | number) =>
        `/ical/admin/feeds/${feedId}/disable`,
