  ...
  dashboard: {
    ...
    bookingManagement: {
      bookingDisputes: {
        ...
        details: (id: string | number) =>
          `/booking-management/booking-disputes/${id}`,
      },
      bookings: {
    ...
    propertyManagement: {
      allProperties: {
        ...
        details: (propertyId: number | string) =>
          `/property-management/all-properties/${propertyId}`,
        verifications: {
          base: (propertyId: number | string) =>
            `/property-management/all-properties/${propertyId}/verifications`,
          details: (
            propertyId: number | string,
            verificationId: number | string,
          ) =>
            `/property-management/all-properties/${propertyId}/verifications/${verificationId}`,
        },
        units: {
          base: (propertyId: number | string) =>
            `/property-management/all-properties/${propertyId}/units`,
          create: (propertyId: number | string) =>
            `/property-management/all-properties/${propertyId}/create-unit`,
          details: (propertyId: number | string, unitId: number | string) =>
            `/property-management/all-properties/${propertyId}/units/${unitId}`,
          bookings: (propertyId: number | string, unitId: number | string) =>
            `/property-management/all-properties/${propertyId}/units/${unitId}/bookings`,
        },
      },
      manageVerifications: {
    ...
    transactions: {
      ...
      bookingWithdrawals: {
        ...
        details: (id: number | string) =>
          `/transactions/booking-withdrawals/${id}`,
      },
    },
    notifications: {
      createNotification: {
      ...
      manageNotifications: {
        ...
        details: (id: number | string) =>
          `/notifications/manage-notifications/${id}`,
      },
    },
    settings: {
      base: "/settings",
